...
season stays. A dried can, an unlabeled jug, a rusted spray bottle goes. Unsure what it is? It
goes — as hazardous waste.

**Dispose right.** Take it to a household hazardous-waste drop-off or recycling center, sorted:
paint and solvent, waste oil, batteries. Never down the drain, onto the ground, or in the trash.
...
Everything but one labeled safety can went to the recycling center that weekend. The soda bottle
scared him most afterward — because it could just as easily have been within a child's reach.

> **Safety**
> - Work with the door open so vapor clears; no smoking, no sparks, no grinding nearby.
...
> 3. Split it: intact and in use (keep) — dried, unlabeled, or unknown (lose).
> 4. Run the "lose" half to the hazardous-waste drop-off, sorted by type.
> 5. Put the survivors back low, cool, labeled, in their original cans — propane outside.
