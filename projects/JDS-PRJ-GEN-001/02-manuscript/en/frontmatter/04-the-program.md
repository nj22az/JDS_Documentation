...
## The problem — what it really looks like

The garage is the one room in the house that nobody quite knows how to fix. It becomes the
home's overflow valve: everything that doesn't fit anywhere else drifts out to it, one item at
...
chapter that shows you exactly how, and a **Weekend Project** box to do right away.

| Step | What you do | Done when | Chapter |
|------|-------------|-----------|---------|
| 1 | **Set the goal.** Take a "before" photo, decide why, pick a date. | You know your goal and have a before shot. | 1–2 |
| 2 | **Empty it out and look.** Carry everything out, group by kind. | It's all out, sorted into like-with-like piles. | 3 |
| 3 | **Keep, lose, or relocate.** Three piles, clear rules. | Every item has one of three fates. | 4 |
| 4 | **Handle the dangerous stuff.** Fuel, paint, chemicals, done right. | The hazard pile is small, safe, and gone. | 5 |
| 5 | **Draw the zone map.** Divide the garage by how you move. | You have a map with five zones. | 6 |
| 6 | **Get it off the floor.** Walls, pegboard, shelves, ceiling. | The floor is clear; everything that can hang, hangs. | 7 |
...
The ten steps are the practical moves. Behind them sits a proven method in five parts — the
same one professionals use to keep workshops in order. It's called **5S**, and you'll meet its
five steps throughout the book:
