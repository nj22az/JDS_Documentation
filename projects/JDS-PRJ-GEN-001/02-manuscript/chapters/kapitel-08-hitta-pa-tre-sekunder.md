...
- **Systematisera** är klart först när vem som helst hittar — och återlämnar — en sak på tre sekunder.
- En plats som bara finns i ditt huvud överlever inte; flytta informationen ut på vägg och låda.
- Märk allt slutet, rita konturer på verktygstavlan, gör ofta-saker genomskinliga.
- Det avgörande är lägga-tillbaka-testet: gör returvägen kortast, så sköter ordningen sig själv.
- När platsen syns lägger man tillbaka rätt utan att minnas — och då klarar systemet hela huset.
