# Amazon KDP — Listing & Metadata (English / primary)

> Sales copy and metadata for *The Garage Reset* (the master English edition, for
> **amazon.com** and other English markets). Paste the description into KDP's description
> field — KDP accepts basic HTML. The Swedish edition's listing is in `amazon-listing-sv.md`.
...
> Working title. Strong alternatives if you want to test: *Tame the Garage*, *The Garage System*,
> *Sort the Garage*. Keep the "10-Step" promise in the subtitle either way.

## Book description (HTML — paste into KDP)

```html
<h2>Finally, a garage where the car fits — and everything has a place.</h2>
...
<li>Keep, lose, or relocate — with clear rules</li>
<li>Handle the dangerous stuff — fuel, paint, chemicals</li>
<li>Draw your zone map</li>
<li>Get everything up off the floor</li>
<li>Label and make it findable in three seconds</li>
<li>Shine it to a clean baseline</li>
<li>Set the four rules that hold the line</li>
<li>Sustain it — ten minutes a week</li>
</ol>
<h3>You also get:</h3>
<ul>
...
6. 10 step garage cleanout
7. 5S at home

## Categories (pick up to 3)

1. Crafts, Hobbies & Home > Home Improvement & Design > How-to & Home Improvements
2. Crafts, Hobbies & Home > Home Improvement & Design > Do-It-Yourself
...
|--------|-----------|-------|
| Kindle eBook | $4.99–$6.99 | 70% royalty band ($2.99–$9.99); impulse price |
| Paperback (later) | $12.99–$15.99 | Once a print interior PDF is produced |
