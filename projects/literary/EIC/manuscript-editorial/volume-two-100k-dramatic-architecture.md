# Volume Two: 100,000-word dramatic architecture
...
The research dossier should shape the novel through emotional functions rather than borrowed scenes. The useful functions are:

- duty that becomes personal betrayal;
- bodily suffering made worse by administrative indifference;
- dangerous laughter among people who know they are being watched;
- documentary proof that is made absent rather than openly destroyed;
...
Thirty-two main chapters, a prologue, and an epilogue give an average narrative unit of roughly 2,940 words. Length should vary with pressure: the hunted middle of Part II uses shorter chapters; aftermath and relationship chapters require room to breathe.
...
- **paper:** authority that may be withdrawn;
- **hands:** the physical work hidden by commissions and accounts;
...
She burns the outside sheet and keeps the inner account. Her house becomes connected to Kidd before Kidd ever reaches England.

**Part III residue:** Nathaniel has survived by abandoning his name. The evidence survives, but its custodians are already separating themselves from it.

## Part IV — The Missing Enclosures

### Chapter 27 — Eight Months in London — 3,000 words

Fenner returns to Wapping and makes himself ordinary. Esther recognises him before he speaks. She gives him Caleb Nix's former room and tells him whose death made it empty.

Their relationship begins with blame, not consolation.

### Chapter 28 — The Docket — 3,100 words

Nathaniel gains brief access to a government paper bundle through a junior clerk who believes he is doing routine carrying work. He does not find a theatrical empty evidence locker. He finds an enclosure list whose numbering jumps, a folded wrapper shaped for thicker contents, disturbed tape or thread, and a docket description that proves the missing papers were once expected.

The exact archival fastening—stitching, tape, thread, wax, or pins—must be verified before prose is locked. The discovery should be understandable to Esther when Nathaniel later demonstrates it with her household accounts.
...
### Chapter 30 — The Trial — 3,100 words

News and transcript pages reach Wapping from the Old Bailey proceedings of 8–9 May 1701. Nathaniel considers presenting himself as a witness but learns that doing so would expose his own service and place him beside Kidd. Esther does not tell him what to do.

He chooses silence during the trial. The novel must allow that cowardice to remain cowardice even though it is understandable.

### Chapter 31 — The First Rope — 3,000 words

On 23 May the crowd becomes an economy: windows rented, boats overloaded, pies sold, places fought over, the condemned turned into a day's trade. Nathaniel initially stays inside. Esther goes because refusing to look would let everyone else define what happened.
...
Nathaniel writes his testimony under his birth name. He includes the passes and Moore's death, because a document that excuses everything is only another commission. He cannot give it to a court without hanging himself.

Louie's chair loses a leg during a quarrel over the best view of the execution. The ridiculous accident occurs beside the making of the record, letting ordinary disorder coexist with grief.

**Part IV residue:** Kidd is dead, Nathaniel is unpunished but not free, and Esther possesses truth that cannot yet be used.

## Epilogue — What the House Keeps

### Summer 1701 — 3,000 words

The crowd is gone and the commercial life of the river has resumed. Esther repairs or cleans Louie's chair while Nathaniel hides his signed testimony within the old timber near the bar. He does not ask whether the hiding place is safe. She does not promise that history will vindicate anyone.

She slides him a hot drink. He takes it. Their silence is not sentimental reconciliation: Esther still remembers Caleb, Nathaniel still remembers Moore, and both know Adams may have deserved a rope for things no English court seriously tried.

What they preserve is not innocence. They preserve the right of later people to know that the official ending was chosen.

## Scene-writing rules that keep the novel alive

### 1. Every history scene must alter a relationship

No fact enters merely because it is interesting. A commission changes how Nathaniel trusts Kidd. A casualty list changes how Esther sees Tanner. A missing enclosure changes whether Nathaniel dares use his own name.

### 2. Every bureaucracy scene must move something tangible

Hands unfold paper, count coins, scrape wax, find a missing tool, test a seal, or turn a ledger towards another person. The reader should always know what a signature, omission, or fee will cost before the paragraph explains the system.

### 3. Humour belongs to the characters

The mock court, slop-seller, broken chair, drink, and Wapping insults provide relief, but each joke exposes status, fear, affection, or dishonesty. Nobody becomes witty merely because the book needs air.

### 4. Violence leaves domestic residue

The body comes home on a plank. A muddy handprint remains on a door. Moore's blood stays in a bucket seam. The broken rope leaves mud on Kidd's clothes. The aftermath matters longer than the blow.

### 5. Institutional greed appears as divided responsibility

No single villain orders every wrong. One man sets the contract, another reduces stores, another follows procedure, another withholds a paper, another profits from the crowd, and each can truthfully say he did not hang anyone.

### 6. Alternate compression and breath

Two high-pressure chapters should be followed by a quieter chapter of consequence, intimacy, or dark humour. The reader needs attachment before loss and silence after spectacle.

### 7. Period language remains transparent

Use precise period nouns—Hollands, geneva, docket, shallop, slops, oakum—where context carries the meaning. Avoid phonetic dialect, ornamental archaism, and modern institutional jargon placed in seventeenth-century mouths.

### 8. Maritime craft reveals character
...
| A drunken mock trial using Louie's chair | Adopt and make Wapping-specific | The Court of the Bent Chair exposes harbour fees, false weights, and Adams's private knowledge |
...
- [Library of Congress: printed arraignment, trial, condemnation, and execution record](https://www.loc.gov/resource/llscd.201000302205929/)
- [The National Archives: surviving French pass associated with Kidd](https://images.nationalarchives.gov.uk/asset/697/)
...
Each completed part receives a continuity, historical, and emotional-rhythm review before the next is treated as fixed.
