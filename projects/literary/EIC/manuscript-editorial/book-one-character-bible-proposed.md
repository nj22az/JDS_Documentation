<!-- PROPOSED Rev-B of the deployed page `book-one-character-bible` -->
<!-- Base text: current deployed bundle extraction, 2026-07-22 -->
<!-- Governing design: editorial/continuity-web-and-cast-reduction.md -->
<!-- Status: awaiting author approval. The deployed reader is unchanged. -->
<!-- Delta changelog at the end of this file. -->

# The Wapping Twelve (1603–1635)

This ledger tells Book One out of school. It keeps the names the Pelican
...
The parish never called them a jury. Later tellings made twelve jurors of the
...
The spine of Book One is not the Company. It is Tom and Maggie, and the
fourteen years they do not speak.

**1612 — the falling out.** When Tom comes back to the Pelican he is no
...
**1626 — the mending.** Tom is forty-five when he next comes through the
...
and the house keeps it long after both of them.

***

## The Defendant

**Maria de Sousa — the catalyst, the survivor.** Both names are other
...
already entered on the *Batavia* muster and sends the VOC a precise warning;
a factor reads every danger as a qualification and sails him anyway. When
Pelsaert returns on the *Sardam* in 1629 to try the wreck's mutineers, Maria
...
pretends that power leaves her clean.

***

## The Dead Man

**Matthew Bell — the compromised witness.** A Shadwell husband, father of
...
and one unanswerable *no*. The room has saved Maria and let Rook go. His
...
formed around his murder while the murdered man remained outside its count.

***

## The Jury

**Juror 1 · Margareta "Maggie" Lindholm-Black — the keeper.** Born
...
*Company clerk* be named Matthew Bell and accepts his account from Maria,
...
but not the obligation to become Maggie.

**Juror 2 · Edward "Ned" Hawkins — the innocent.** The young lighterman by
...
can see both banks of, and never once signs a deep-water Company paper.

**Juror 3 · Silas Rook — the aggressor.** Rock, to the men who have tried
...
entered on the *Batavia* muster and warns the Company exactly what he is;
...
His murders remain his; the room's failure to hold him remains the room's.

**Juror 4 · William Carter — the sage.** The heavy, fair-dealing
...
noticing what the honest things are for.

**Juror 5 · Barnaby Gale — the vulnerable.** The old sailmaker by the
...
room lets him, and both of those things mean something.

**Juror 6 · the caulker — the everyman.** The first of Carter's two tar men
...
— short measure being a thing a tar man knows when he handles it.

**Juror 7 · Henry Mercer — the hedonist.** Ship's cooper, the second tar
...
calibrated to be heard and not answered.

**Juror 8 · Thomas "Tom" Fletcher — the holdout.** A stoic Essex boy of
...
once, leaves it lying and says goodnight to Maggie on his way out.
...
**Juror 10 · Josiah Grimes — the bigot.** A beached sailor — one Baltic
...
is the house's way. Nobody sits close.

**Juror 11 · Nathaniel Pell — the immigrant's witness.** The quiet sailor
...
which is to say: as muster.

**Juror 12 · Arthur Higgins — the trickster.** Purser's mate on the Levant
...
occasionally one line leaning the other way.

***

## Beyond the Twelve

The room was never the whole of it. Every juror's account runs out through
...
has already promised not to.

### The Bell Household

**Anne Bell — the widow who would not be edited.** A Shadwell wife who
...
one empty satchel his search recovers. *Legal eats less bread than theft*
...
will not let his ending enter her house.

**Joan Bell — the keeper who came after.** Matthew and Anne's elder
...
that the first fact makes the second one heavier.

### The Mercer Line

**Jack Mercer — the boy who asked twice.** Henry Mercer's nephew, son of
...
that she will know which empty space in a contract to fear.

### The River

**Hendricks — the ferryman.** A Dutch waterman who has hauled timber on the
...
**Pieter — the one who could not hold both.** Hendricks's younger brother,
...
can barely reach the margin — *make another.* Maria does. It is the origin
of every duplicate she will ever keep.

### Daniel's Thread

**Daniel Vale — the true copy.** A Rochester merchant's clerk with a quick
...
exchange — *what did you count on the way in?* — the difference between
...
of it aloud and are still sitting next to each other.

**Nell Vale — the one who came looking.** Married to Daniel one year when
he sails for Amboyna, and the one who says aloud, the night before he
leaves, what he will not: *you want to come back worth a story.* She reads
...
nearly the wisest sentence in the book.

### Maria's Network

**Joos de Vries — the audited mercy.** Deacon of the Dutch church at Austin
Friars and part-owner of the fluyt *De Hoop*, the man Matthew Bell went
...
*when did the church last get a chance to do a thing this clean?* — and de
...
uses the word *owns*, which does not change the price. His mercy runs
entirely through bookkeeping, and Maria comes to understand that audited
mercy is the only kind the powerful cannot later deny.

**Lysbeth van Aalst — the surgeon's widow.** Sails for Bantam in 1604 with
...
ownership (*van mij*, *eigen*, *toestemming*) for the discipline of a woman
...
wages — the cleanest document either woman has ever read.

**Willem van Aalst — the boy who signs his own name.** Lysbeth's son, seven
...
letters no longer lean on each other for support. *I practised*, he tells
her, and it is the closest she ever comes to praising a child.

**Iskandar — the broker who waited.** A Bantam pepper broker whose disputed
...
**Aminah — the higher rate.** Maria's correspondent between Hitu and the
...
trades and lets the rest of them stay safely unentered.

**Rafi — the paid account.** A seventeen-year-old courier who drowns in the
...
the word *courier*, because "the account needs a purpose" and payment owed
is the only purpose death has left it.

**Ratan — the honest flaw.** A Gujarati cloth broker outside Surat who
...
anyone deciding to profit from it on purpose.

**Yusuf — the missing stroke.** A Surat warehouse porter nearly punished
...
### The Machine's Servants

**Master Harcourt — the unseen hand.** A London merchant who traded under
...
**The steward — the collections trade.** One dry, well-kept man, and the
...
masters always have, that the man is theirs.

**The clerk of the record — the editor.** The young-old man in the black
...
Company's coat over the same habits — writes *examined with some severity*
...
no name for him. It keeps the wax.

***

## The Keeper's Appendix

The keeping is a trade, not a title deed: three habits taught hand to hand.
Feed first. Ask the real question — *that was not my question.* Keep the
...
and who it is usually sold to. The house does not prove. The house keeps.

## The Counter-Ledger's Appendix

What the fault holds, and in what order it learned to hold it. First the
...
The blood runs thinner than the debts do. Jack Mercer is Henry Mercer's
...
be where the unrelated finally met.

***

A last word out of school. The parish records kept no such page, and the
...
<!-- DELTA CHANGELOG vs the deployed page (for review):
1. Mara → Maria throughout (18 occurrences in the base text).
2. The Defendant entry rewritten: baptismal-name logic; concealed Japanese
   heritage (samurai-class Kirishitan family destroyed after her father
   moved against a warlord; Nagasaki → Macau; Cantonese from the Macau
   years); the never-speaks-Japanese discipline; English "always her
   weakest"; the ten Amboyna names recovered through her (the one
   authorized new station); the packet's "fifth hand that exists and is
   never written."
3. Bell/Rook/Maggie/Tom/network entries: name updated only; no other
   change.
4. Juror 9 (Elias Thorne): added the Tregowan guard sentence.
5. Joan Bell entry: added the blue-cotton addition (her one entry in the
   fault), per the cache strata model.
6. Aminah entry: added the two-storage-hands compression sentence
   (Masulipatam box, Patani rice jar — "safely unentered").
7. "The Merchant" section renamed "The Machine's Servants"; added two new
   entries: The Steward (Harcourt's = Carter's, one freelance
   steward-of-accounts) and The Clerk of the Record (1603 coroner's clerk
   = 1626 deposition clerk).
8. New: The Keeper's Appendix (trade defined; succession by trade through
   the Finch women; the male leaseholder acknowledged; unprovability
   guard).
9. New: The Counter-Ledger's Appendix (three-strata model; the index
   sheet; the hooked letter; Joan's cloth as binding; the 2019 division
   foreshadowed in the ledger's own voice).
10. Closing paragraph: added the steward/clerk namelessness sentence.
All other text is verbatim from the deployed page. -->
