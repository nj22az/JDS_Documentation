...
Imported from the anthology's character map (`../manuscript/appendix-1b-character-map.md`), which is the authoritative statement. Summary: the Keepers (a trade, aunt to niece to daughter); the Cache (notches + five objects, found in 2019 and divided so no single owner holds the whole — **closed set: no book may add or remove an object**); the Practice (the Canton thread); the Johansson line (never stated in any chapter); the room itself (scar tissue: Louie's chair, the lopsided table, the fuchsia, the gin thread — **never explained in-story, by anyone, in any book**).
...
4. The Cache is a closed set (notches, thimble, the keeper's signing-sheet, true copy, testimony, notebook); no character who leaves an item knows of another's; found once, in 2019, and divided by Hannah so that no single owner ever receives the whole account (author's 2019 rewrite supersedes the earlier "found and left").
...
- **[Book One ch6, drafted]** Tom's farewell: "Mind the thimble" / "Mind your words, sailor" (was "Mind your figures, writer" before the seaman recast); the heel of bread from Mara — the same-weather transaction, no words. The fleet (four ships, spring 1604) passes Wapping on the ebb; Mara raises the jug a hand's width at the second ship; Hendricks bareheaded on his barge; Maggie stays behind the counter. Maggie's line: "Ships are loud going and quiet coming. It is the quiet you learn to listen for."
...
- **[Book One, character pass + seaman recast (author-directed, site-side, 2026-07-13)]** **Tom**: a coastwise seaman, NOT a writer — before the mast, second voyage, eighteen shillings a month with one half assigned by prior instrument to **Master Harcourt** until his father's account (£11 6s 4d) is clean. His father: boatswain for Harcourt's Levant ships (Smyrna, Scanderoon, sometimes Venice) twenty-three years, knee broken on the last passage, charged for stores lost in the same storm (cable, two coils of running rigging, a kedge anchor); rented rooms behind the millpond, in the shadow of the tithe granary (the granary is scenery now, not the family trade); a silent exact man whose only language is terrible jokes ("load-bearing"). Harcourt moved his capital from the Levant seal to the East India seal, and the debt walked across with him — "Same man. New seal." The seamstress mother (word-a-day game, letters, the thimble, fever at fourteen) is unchanged; the next spring his father first took him on the coasters (Newcastle twice, Calais once; hand, reef and steer; eye, short and long splices). He keeps the penny memorandum-book of words; whistles through the gap in his teeth while writing; on the crossing the book becomes the mess's book — men queue at his hammock to have their words "wrote fair" — and goes home to Essex with the purser's letter. His two lines in the ship's books: "the muster, where the clerk wrote him, and the mess's book, where he wrote everyone else." After his death, Harcourt's account "stays open" (Book One ch7) — how it ends is unwritten; leave open.
...
- **[Anthology ch1 + Book One ch1–3, twelve-voice rework]** The wager night's room numbers **exactly twelve**, and the count never varies in any telling: Maggie, Tom, Mara, Rook, the old docker, the graveyard-cough man, the two tar men, the snow bettor, **Carter the elder**, **Ned the lighterman**, and **Pell**. The debt is settled by deliberation, not force. Rook opens the evening by demanding the room witness the sale ("a parish of honest men will do for a register") — silence is signature, and Mara knows it. The fight beats stay canon (Rook's first blow, Tom's one clean hit, Mara's mug across the wrist), but the fight settles nothing: Rook appeals to paper ("Which of you unmakes a paper?"), and the room answers voice by voice — snow bettor ("a wager without witnesses is not won, it is only told"), Carter ("if it is a true paper, it can be bought like one — nobody tears anything"), Pell, Ned (water-law: "she is owed a landing"), the cough man ("I am dying, and I say it lies"), the tar men ("short measure"), Mara herself ("a paper that cannot spell a woman has no business selling one"), and the old docker, who calls the price ("the room sets the price — custom on this stair since before the Armada. Keeper. Name it."). Maggie buys the paper for one of Tom's coins — "twelve souls tonight, counting me: ten witnesses, a buyer and a seller" — and Rook, honouring the form he has instead of a religion, says "Witnessed," lays the paper down and takes the coin. His true wound: he finds himself holding the count-house's side of a grown paper, the thing that ruined his mother.
- **[Anthology ch1, new character]** **Carter the elder**: rope-and-tar chandler off Wapping Wall, father of ch10's young Carter (dies 1618); a young son at home in 1603. His creed — the world holds together with cordage and clean paper; a true paper may be bought, never torn — is the family's paper-religion a generation early. The tar arguers' standing winter argument is about HIS barrels (still true of his son's barrels in 1630).
- **[Anthology ch1, new character]** **Ned**: young lighterman of the stairs, a year out of his apprenticeship, half-pint by the door; the water-law voice among the twelve. Future father of **Joan** (b. ~1615), the lighterman's orphan Maggie trains from ~1628 — the keeper line's next hand first stands up in this room a dozen years before she is born. He must die before ~1628 (how is unwritten; leave open).
- **[Anthology ch1–2 + Book One ch1–3, Pell timeline]** Pell came up from Blackwall **alone, on the wager afternoon**, ahead of his watch: the unplaced salt-stiff sailor at the counter's end through the paper talk and the wager, revealing himself mid-deliberation ("Off the Dragon. First fleet… a hundred and five buried before the Cape; muster in one column, cargo in the other — start writing people into the cargo column ashore, and don't be surprised at what comes home in the holds"). The rest of the Dragon's pay-off arrive an hour after the wager and find him already moored. This makes his 1606 line — "he stood a room's length from me once and bought a debt off a table" — literally true.

- **[Author site-side recast, synced 2026-07-16]** **Tom is a seaman, not a writer** (see the rewritten character-pass entry above). Ripple applied through anthology ch1–ch2, the 1626 line ("The seaman who signed… with half his wages promised against his father's debt"), and Book One ch1–4, 6–7. Pell's catechism replaces "we need men who can count": Able? / splice / wheel / "Then you are a seaman, whatever figure the clerk writes beside you."
- **[Author site-side rewrite, synced 2026-07-16]** **2019 chapter is now "What Jerry Bought."** **Gerald "Jerry" Vale** (Albion Reach Capital — surname deliberately shared with Daniel Vale, 1626) buys the pub company's debt inside Wapping Heritage Holdings No. 2; knows the Company's history precisely and admires the structure; offers Hannah a "heritage partnership" (THE WOMEN WHO KEPT THE RIVER) and custody of the Cache's images in perpetuity. **Abdi Warsame**, courier under a Northreach policy Jerry approved. Hannah divides the Cache: Blitz notebook → borough archive via the cousin in Bow; Nathaniel's paper → family custody; thimble + Tom's sheet stay in the wall. Epigraph: "You bought the debt. You keep talking as though you bought the past."
- **[Author addition, 2019 §V]** New Cache object: **the keeper's folded sheet of names beside marks** — the first simply *Tom*, and after it, in another hand, *signed Thursday*. Implies the keepers kept a written signing-list alongside the notches; who wrote which hand is deliberately unstated. (Loose end, tolerated: the rewritten 2019 chapter no longer names the Amboyna sheet's disposition when Hannah divides the custody.)
- **[Book One ch7, seaman ripple]** Harcourt's account survives Tom: "The account at Harcourt's, which knows no difference between an ocean and a ditch, stays open." How the father's debt ends is unwritten — reserved for a later chapter or book.
