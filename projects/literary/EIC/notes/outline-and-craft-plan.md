...
| 1774 | Naylor, a Company tea-warehouse tallyman | Thirty-one years of exact, ignored counts; ordered to tally the stale hoard out to America, he writes to his nephew in Boston warning that the cheapness is the hook and the threepence is the precedent — against his employer, signed, knowing letters get opened. Never learns if it mattered; his nephew's careful reply is 'an answer of a kind.' | His hooked-N tally marks end up on chests at the bottom of Boston harbour. §VI "The Boston Man" (added 2026-07-08): James Holman, an American mate off the Nantucket oil trade (named per author direction; elaborated 2026-07-08: harpooner-turned-mate, try-pot burn, a scrimshawed tooth of his wife "drawn from memory, four voyages," lapsed Nantucket Quaker whose single "thee" slips out at the port-closing peak — the book's only two uses of the word). His quotable ledger: the heart-of-a-company line, knowing-when-to-cut, "We light London so London can read the Acts it writes against us," and the grandchildren line. He corrects the room — the tea ships were American-owned, the tea loaded in the Thames — and, unasked, leaves open the offer of a word carried to the Long Wharf; Naylor asks after Ben's shop without naming it and lets the offer stand untaken (keeps §VII's "he never learns" intact). |
| 1790 | Alec Munro, whose brother Davy was aboard the Bounty | Claims the connection publicly when a stranger asks the room directly, rather than hide it. | Carries the Hastings-impeachment thread ("The Other Trial"): Burke's prosecution of the Company's rule, third year, losing the public to a better sea story — re-tethers the interlude to the Company and sets up the 1858 acquittal exchange. |
...
| 1888 | Su Zhang | Expanded (2026-07-02) into the book's centerpiece (~5,000 words, 12 sections) per author direction: Su's moral compass built from two inheritances (her father's four rules — never first, never for show, never for payment, never in anger — and her mother's God); she knows Long Liz and Kate before the double event takes both in one night; the martial art built properly from her grandfather's Canton practice ("the work") through training, conditioning, and the two prior uses; a Nobody-to-Tell section explaining why the police are closed to her (Leather Apron mobs, a gentleman's word); an expanded fight whose mechanics pay off the training beat-for-beat; and the case sunk unopened so the mystery survives inside the story — the killings stop, and no one, Su included, ever knows if Cray was the Ripper. This chapter is the model for future deepening passes. | — |
