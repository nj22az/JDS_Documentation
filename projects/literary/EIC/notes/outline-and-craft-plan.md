...
| 2019 | Hannah and Jerry Vale | Hannah confronts the hedge-fund manager whose fictional fund has bought distressed debt attached to the Prospect and wants the Cache as proprietary heritage content. She documents and divides the record so no single owner can suppress or monetise it whole. Jerry wins the property transaction but not exclusive ownership of the memory. | **Cache payoff and modern-antagonist chapter.** Tom signs without seeing the machine; Jerry studies the whole history and chooses it. Editorial expansion drafted in `manuscript-editorial/14-2019-what-jerry-bought.md`. |

Status: all 14 chapters now have an active protagonist. The Cache holds three items (1603, 1701,
1940); the 2019 editorial expansion documents and divides it to prevent exclusive ownership. Both scar-tissue pairs (Louie's chair 1701→1888; the
